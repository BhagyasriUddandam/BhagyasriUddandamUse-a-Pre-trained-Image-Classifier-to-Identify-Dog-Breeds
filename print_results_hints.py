...
def print_results(custom_results_dict, custom_stats_dict, selected_model, 
    ...
    # IF print_misclassified_dogs == True AND there were images incorrectly 
    ...
    # IF print_misclassified_breeds == True AND there were dogs whose breeds 
    ...
    if (print_misclassified_breeds and 
        ...
        for key in custom_results_dict:
            ...
            if ( sum(custom_results_dict[key][3:]) == 2 and
                custom_results_dict[key][2] == 0 ):
                print("Real: {:>26}   Classifier: {:>30}".format(custom_results_dict[key][0],
                                                          custom_results_dict[key][1]))
