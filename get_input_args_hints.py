...
def get_command_line_args():
    ...
    # text file with names of dog breeds.
    command_line_parser.add_argument('--dir', type=str, default='pet_images/', 
                                     help='path to folder of images')
    # TODO: 1a. EDIT command_line_parser.add_argument statements BELOW to add type & help for:
    #          --arch - the CNN model architecture
    #          --dogfile - text file of names of dog breeds
    command_line_parser.add_argument('--arch', default='vgg', 
                                     help='CNN model architecture for classification')
    command_line_parser.add_argument('--dogfile', default='dognames.txt', 
                                     help='path to text file with names of dog breeds')

    # TODO: 1b. Replace None with command_line_parser.parse_args() parsed argument 
